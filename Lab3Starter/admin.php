...
<div class="h-50 center-me text-center">
    <div class="my-auto upload-container">
       ...
       <img src="img/car1.jpg" onclick="triggered();" id="gallery-display">
        ...
        <div class="form-group">
            <textarea name="descript" id="descript" col="30" rows="3" placeholder="Description" style="text-align: center;">
